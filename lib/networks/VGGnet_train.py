...
class VGGnet_train(Network):
    def __init__(self, trainable=True):
        ...
        with tf.variable_scope('bbox_pred', reuse=True):
            ...
            self.bbox_weights = tf.placeholder(weights.dtype,
                                               shape=weights.get_shape())
            self.bbox_biases = tf.placeholder(biases.dtype,
                                              shape=biases.get_shape())
    ...
    def setup(self):
        ...
        (self.feed('rpn_cls_score', 'gt_boxes', 'im_info', 'data')
         .anchor_target_layer(_feat_stride, anchor_scales,
                              name='rpn-data'))
        ...
        (self.feed('rpn_cls_prob_reshape', 'rpn_bbox_pred', 'im_info')
         .proposal_layer(_feat_stride, anchor_scales,
                         'TRAIN', name='rpn_rois'))
